...
| ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| [**JOBIS**](https://github.com/kdHyeok/Jobis-PJT) | 채용 공고의 요구 역량과 사용자의 실제 경험을 근거 단위로 대조해 부족 역량을 로드맵·학습 플랜으로 연결하는 AI 커리어 에이전트입니다. 데이터·인프라 담당으로 5개 채용 사이트 수집·OCR·RAG 파이프라인과 Jenkins CI/CD를 구축했습니다. | LangChain, LangGraph, Airflow, PostgreSQL, Docker, Jenkins, AWS EC2 |
...
![Raspbian](https://img.shields.io/badge/Raspbian-A22846?style=flat-square&logo=raspberrypi&logoColor=white)
